...
| Ver | Commit | Notes |
|-----|--------|--------|
| **v5.15** | **`1dc65d5`** | Site logo → **Naka mascot** (retire enso cyan/green mark) |
...
| **v5.5** | **`cfa4bd4`** | Learn you / four-tiered memory sitewide; JB likes simple clean no-BS |
...
- **Company:** builds **AI employees**, **custom AI solutions**, plus **AI consulting** and **technology consulting** for businesses
- **Flexible path:** help **with or without** an AI employee — consulting/tools/custom work still valid  
