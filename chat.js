...
(function () {
  ...
  function build() {
    ...
    launcher.innerHTML =
      '<img class="nk-chat__launcher-face" src="assets/naka/Naka_Smile_Green.png?v=naka10" width="28" height="28" alt="" />' +
    ...
    head.innerHTML =
      ...
      '<img class="nk-chat__head-face" src="assets/naka/Naka_Smile_Green.png?v=naka10" width="40" height="40" alt="" />' +
