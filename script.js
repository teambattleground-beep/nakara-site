...
(function () {
  ...
  var belowFold = document.querySelectorAll(
    '.audience__lead, .audience-card, .problem__item, .stop__item, .feature, .cycle__step, .pillar, .usecase, .early__lead, .early__list, .faq-behind__card, .faq__item, .cta__h, .cta__sub, .cta__form, .footer__inner'
  );
